...
function requireConfig(code: CountryCode): CountryPhoneConfig {
...
const AU = requireConfig('AU'); // trunk prefix "0"
const GB = requireConfig('GB'); // trunk prefix "0", mask INCLUDES the 0
const DE = requireConfig('DE'); // trunk prefix "0", mask INCLUDES the 0
